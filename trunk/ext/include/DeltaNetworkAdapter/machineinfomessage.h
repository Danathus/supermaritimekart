// note: this code is copied from dtNetGM and modified to suit this project...
...
namespace DeltaNetworkAdapter
{
    ...
    */
   class DELTANETWORKADAPTER_LIBRARY_EXPORT MachineInfoMessage : public dtGame::Message
   {
   public:
      // Constructor
