...
//{
   ...
   public:
      ...
      /**
       * @param destination A NULL destination indicates it's intended for the matchmaker/server
       * @return True if dispatched successfully. Note: does not guarantee success of reception.
       */
      //bool SendNetworkMessage(dtGame::Message& message, const CCTS::RoleActor* destination, TransmissionProtocol protocol = TRANSPORT_DEFAULT);
      /**
